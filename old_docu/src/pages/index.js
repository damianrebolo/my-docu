      ...
      <header className={clsx('hero hero--primary', styles.heroBanner)}>
        <div className="container">
          ...
          <p className="hero__subtitle">
            ...
            several web technologies during my career. At the moment I’m focusing on front-end
            development building real time single page applications.
          </p>
